...
class DocumentGridSection extends StatelessWidget {
  final String? title;
  final List<DocumentItem> items;
  final void Function(DocumentItem item)? onPressed;
  final bool border;

  const DocumentGridSection({
    Key? key,
    this.title,
    required this.items,
    this.onPressed,
                   ...
                   // onTap: onPressed != null ? () => onPressed!(item) : null,
                    onTap: () {
                      if (item.title == "Quotation") {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const SurveyListPdf()),
                        );
                      } else if (item.title == "Packing List") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const PackingListPdf()),
                        );
                      } else if (item.title == "LR–Bilty") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const LrBiltyPdf()),
                        );
                      } else if (item.title == "Proforma invoice") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const ProformaInvoicePdf()),
                        );
                      } else if (item.title == "Bill") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const BillPdf()),
                        );
                      } else if (item.title == "Money Receipt") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const MoneyReceiptPdf()),
                        );
                      } else if (item.title == "Car Condition") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const CarConditionPdf()),
                        );
                      } else if (item.title == "Payment Voucher") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const PayementVoucherPdf()),
                        );
                      } else if (item.title == "Tws Form") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const TwsFormPdf()),
                        );
                      } else if (item.title == "Fov-Scf Form") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const FovScfFormPdf()),
                        );
                      } else if (item.title == "NOC Letter") {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const NocLetterPdf()),
                        );
                      }
