class CarConditionReportModel {
  bool? status;
  String? message;
  List<Data>? data;
  Pagination? pagination;

  CarConditionReportModel({this.status, this.message, this.data, this.pagination});

  CarConditionReportModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
