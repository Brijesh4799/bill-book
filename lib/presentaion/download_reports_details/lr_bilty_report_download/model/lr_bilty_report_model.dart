class LrBiltyReportDownloadModel {
  bool? status;
  String? message;
  List<Data>? data;
  Pagination? pagination;

  LrBiltyReportDownloadModel({this.status, this.message, this.data, this.pagination});

  LrBiltyReportDownloadModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
