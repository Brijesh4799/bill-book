...
class HomeNavControllerState extends State<HomeNavController> {
  ...
  Widget _buildBottomNavItem({
    ...
    // final color = isSelected ? const Color(0xFF137DC7) : Colors.black;
...
class HomeNavControllerState extends State<HomeNavController> {
  ...
  void _onItemTapped(int index) {
    if (index == 2) return; // Floating button handled separately
    setState(() {
      _currentIndex = index;
    });
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            setState(() {
              _currentIndex = 2; // Floating action button goes to QuotationScreen
            });
          },
          backgroundColor: const Color(0xFF137DC7),
          child: const Icon(Icons.add, size: 32, color: Colors.white),
