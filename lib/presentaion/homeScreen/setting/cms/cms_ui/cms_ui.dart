              ...
              builder: (context, provider, child) {
                ...
                return SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                     /* Text('Agreement: ${cmsData.agreement ?? "-"}'),
                      const SizedBox(height: 10),
                      Text('Terms & Conditions: ${cmsData.termAndConditions ?? "-"}'),
                      const SizedBox(height: 10),
                      Text('Privacy Policy: ${cmsData.privacyPolicy ?? "-"}'),
                      const SizedBox(height: 10),
                      Text('Refund Policy: ${cmsData.refundPolicy ?? "-"}'),*/
                      const SizedBox(height: 10),
