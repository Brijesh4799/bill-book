...
class _CarConditionEditScreen extends State<CarConditionEditScreen> {
  ...
  void initState(){
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final billProvider = Provider.of<CarConditionPdfProvider>(context, listen: false);
      billProvider.fetchcarById(id:widget.id );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: SafeArea(
          child: Padding(
            padding: const EdgeInsets.all(12.0),
            child: Consumer<CarConditionPdfProvider>(
