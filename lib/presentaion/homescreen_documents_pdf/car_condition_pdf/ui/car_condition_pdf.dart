...
import '../car_condition_pdf/download_car_pdf.dart';
import '../car_condition_pdf/share_car_pdf.dart';
...
class CarConditionPdf extends StatefulWidget {
  ...
  @override
  State<CarConditionPdf> createState() => _CarConditionPdfState();
}

class _CarConditionPdfState extends State<CarConditionPdf> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Provider.of<CarConditionPdfProvider>(context, listen: false)
          .carconditionData();
    });


    _scrollController.addListener(() {
      final provider = Provider.of<CarConditionPdfProvider>(context, listen: false);
      ...
      if (_scrollController.position.pixels ==
        ...
        provider.carconditionData(isLoadMore: true);
      }
    });
        ...
        builder: (context, provider, child){
          ...
          return Scaffold(
            ...
            body:  CustomPageRefresher(
                onRefresh: () async{
                  await provider.carconditionData();
