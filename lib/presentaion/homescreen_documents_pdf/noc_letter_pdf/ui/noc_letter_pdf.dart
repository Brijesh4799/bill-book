...
import '../../../homeScreen/nocLetterscreen/ui/noc_letter_screen.dart';
...
class NocLetterCard extends StatefulWidget {
  const NocLetterCard({super.key});

  @override
  State<NocLetterCard> createState() => _NocLetterCardState();
}

class _NocLetterCardState extends State<NocLetterCard> {
                                  ...
                                  onTap: () {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        ...
                                        builder: (context) => NocLetterPdfWebViewScreen(id: item.sId ?? ''),
                            ...
                            children: [
                             ...
                             /* Expanded(
                                child: InkWell(
                                  onTap: () {
                                    PdfDownloadershare.downloadAndSharePdf(
                                      "http://167.71.232.245:8970/api/user/noc/${item.sId}/pdf",
                                    );
                                  },
                                  child: Container(
                                    padding: EdgeInsets.all(5),
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            Text('Share Noc',
                                                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                                            Text('Noc पीडीएफ भेजें', style: TextStyle(fontSize: 12)),
                                          ],
                                        ),
                                      ],
                                    ),
