...
import '../../../homeScreen/BillScreen/provider/bill_provider.dart';
import '../../../homeScreen/home_controller.dart';
import '../provider/bill_pdf_provider.dart';

class BillEditScreen  extends StatefulWidget {
  final String id;
  const BillEditScreen ({Key? key, required this.id}) : super(key: key);
  @override
  _BillEditScreen  createState() => _BillEditScreen ();
}
...
// Checkbox state for "Same as Billing"
  ...
  void initState(){
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final billProvider = Provider.of<BillPdfProvider>(context, listen: false);
      billProvider.fetchbillById(id:widget.id );
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        bottomNavigationBar: SafeArea(
          child: Padding(
            padding: const EdgeInsets.all(12.0),
            child: Consumer<BillPdfProvider>(
                ...
                return ElevatedButton(
                  onPressed: () async {
                    ...
                    if (updatedBill != null) {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('update bill')),
                      );
                    }
                  },
