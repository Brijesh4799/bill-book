...
import '../lr_bilty_pdf_screen/download_lr_bilty_pdf.dart';
import '../lr_bilty_pdf_screen/lr_bilty_pdf_screen.dart';
import '../lr_bilty_pdf_screen/lr_bilty_pdf_share.dart';
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      ...
      if (_scrollController.position.pixels ==
        ...
        provider.fetchlrbiltyListData(isLoadMore: true);
      }
    });
  }
        ...
        builder: (context, provider, child){
          ...
          return Scaffold(
            ...
            body: CustomPageRefresher(
                onRefresh: () async{
                  await provider.fetchlrbiltyListData();
                                      ...
                                      Container(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text('${item.formData?.truckVehicleDetails?.truckVehicleDriverPhoneNumber.toString() ?? "N/A"}'),
                                            const Spacer(),
                                            Row(
                                              children: [
                                                Container(
