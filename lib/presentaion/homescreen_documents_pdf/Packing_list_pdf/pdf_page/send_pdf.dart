...
class PdfDownloadersharepackage {
  ...
  static Future<void> downloadAndSharePdf(String quotationId) async {
    try {
      ...
      if (responseBytes != null) {
        ...
        final filePath = '${directory.path}/packing_$quotationId.pdf';
        ...
        // Share the PDF
        await Share.shareXFiles([XFile(filePath)], text: 'Here is your Packing PDF!');
      } else {
