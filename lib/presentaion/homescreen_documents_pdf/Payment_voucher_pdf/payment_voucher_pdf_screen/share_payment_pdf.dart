...
class PdfDownloadersharepayment {
  ...
  static Future<void> downloadAndSharePdf(String quotationId) async {
    try {
      ...
      if (responseBytes != null) {
        ...
        final filePath = '${directory.path}/payment_$quotationId.pdf';
        ...
        // Share the PDF
        await Share.shareXFiles([XFile(filePath)], text: 'Here is your Payment PDF!');
      } else {
